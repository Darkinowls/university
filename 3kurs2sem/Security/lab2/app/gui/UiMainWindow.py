...
class UiMainWindow:
    def setupUi(self, MainWindow):
        ...
        self.button_test_captcha = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.button_test_captcha.setObjectName("button_test_captcha")
        self.gridLayout_2.addWidget(self.button_test_captcha, 6, 0, 1, 1)
        self.gridLayout_2.addWidget(self.button_test_recaptcha, 7, 0, 1, 1)
